...
export const USF_BUILDINGS_CATALOG: USFBuilding[] = [
  {
    ...
    hours:
      "24/5 during semesters (Opens Sunday 10am, 24hrs through Friday 6pm)",
    aliases: [
      "library",
      "tampa library",
      "starbucks",
    ...
    roomsAndServices: [
      {
        ...
        floor: "1st Floor",
        type: "dining",
        details: "Mobile ordering available via Grubhub",
      },
      {
        name: "Digital Media Commons (DMC)",
        floor: "1st Floor",
        type: "amenity",
        details:
          "Free 3D printing, podcast studios, VR lab, and audio gear checkout",
      },
      {
        name: "IT Help Desk & Tech Support",
        floor: "1st Floor",
        type: "service",
        details: "Walk-in laptop, WiFi, and NetID assistance",
      },
      {
        name: "Academic Success Center (ASC)",
        floor: "2nd Floor",
        type: "service",
        details: "Free peer tutoring in STEM, business, and writing",
      },
      {
        name: "The Writing Studio",
        floor: "2nd Floor",
        type: "service",
        details: "1-on-1 essay and resume feedback",
      },
      {
        name: "Quiet Study Hall",
        floor: "3rd & 4th Floors",
        type: "study",
        details: "Desks with charging outlets and study pods",
      },
      {
        name: "Silent Study Zone",
        floor: "5th Floor",
        type: "study",
        details: "Strictly silent floor with sweeping campus views",
      },
      {
        name: "Special Collections & Archives",
        floor: "4th Floor",
        type: "office",
        details: "Florida history, rare manuscripts, and USF yearbooks",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "MSC Food Court (Chick-fil-A, Panda Express, Subway, Moe's)",
        floor: "1st Floor",
        type: "dining",
        details: "Accepts Bull Bucks, Dining Dollars, and credit cards",
      },
      {
        name: "Panera Bread",
        floor: "1st Floor",
        type: "dining",
        details: "Breakfast, coffee, pastries, and lunch",
      },
      {
        name: "USF Federal Credit Union",
        floor: "1st Floor",
        type: "service",
        details: "Full-service student banking and ATMs",
      },
      {
        name: "USF Card Center",
        floor: "1st Floor (MSC 1504)",
        type: "service",
        details: "Get your official USF Student ID card",
      },
      {
        name: "MSC Information & Help Desk",
        floor: "1st Floor",
        type: "service",
        details: "Campus maps, lost and found, and general directions",
      },
      {
        name: "Center for Student Involvement (CSI)",
        floor: "2nd Floor (MSC 2300)",
        type: "office",
        details:
          "Join 700+ student organizations, Greek life, and campus events",
      },
      {
        name: "USF Student Government (SG)",
        floor: "4th Floor (MSC 4300)",
        type: "office",
        details: "Student Senate, executive cabinet, and free legal aid",
      },
      {
        name: "MSC Ballrooms (A-C)",
        floor: "2nd Floor",
        type: "amenity",
        details: "Major campus lectures, concerts, orientations, and banquets",
      },
      {
        name: "Bulls Country Pharmacy",
        floor: "1st Floor",
        type: "service",
        details: "Prescription pickup and over-the-counter medicine",
      },
      {
        name: "Oval Theater",
        floor: "1st & 2nd Floors",
        type: "amenity",
        details: "700-seat auditorium for movie nights, comedy, and keynotes",
      },
      {
        name: "Beef 'O' Brady's Sports Bar & Grill",
        floor: "1st Floor",
        type: "dining",
        details: "Casual dining with wings, burgers, and sports TV screens",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Central Honors Atrium",
        floor: "1st Floor",
        type: "amenity",
        details: "Open social space and campus gathering hub",
      },
      {
        name: "Honors Advising Suite",
        floor: "2nd Floor",
        type: "office",
        details: "Specialized honors academic advising and fellowship coaching",
      },
      {
        name: "Food & Culture Lab Studio",
        floor: "3rd Floor",
        type: "classroom",
        details: "Hands-on experiential culinary and cultural learning",
      },
      {
        name: "Design & Technology Lofts",
        floor: "4th Floor",
        type: "study",
        details: "Collaborative computing, design pods, and study areas",
      },
      {
        name: "Acoustic Music Practice Rooms",
        floor: "2nd Floor",
        type: "amenity",
        details: "Sound-isolated practice rooms for musicians",
      },
    ],
  },
  {
    ...
    hours:
      "Mon-Thu 6:00 AM - 11:00 PM, Fri 6:00 AM - 9:00 PM, Weekends 9:00 AM - 8:00 PM",
    aliases: [
      "rec",
      "gym",
      "fitness",
    ...
    roomsAndServices: [
      {
        name: "Cardio & Weight Training Deck",
        floor: "1st & 2nd Floors",
        type: "amenity",
        details:
          "150+ weight machines, squat racks, free weights, and treadmills",
      },
      {
        name: "Indoor Basketball & Volleyball Courts",
        floor: "1st Floor",
        type: "amenity",
        details: "4 full hardwood courts for pickup basketball and intramurals",
      },
      {
        name: "Suspended Indoor Running Track",
        floor: "2nd Floor",
        type: "amenity",
        details: "1/8th mile cushioned running and walking track",
      },
      {
        name: "Indoor Heated Lap Pool",
        floor: "1st Floor",
        type: "amenity",
        details: "25-meter lap lanes and aquatic fitness classes",
      },
      {
        name: "Group Fitness Studios (A & B)",
        floor: "2nd Floor",
        type: "classroom",
        details: "Free yoga, Zumba, spin cycling, and HIIT sessions",
      },
      {
        name: "Outdoor Equipment Rental Desk (OEP)",
        floor: "1st Floor",
        type: "service",
        details: "Rent tents, kayaks, paddleboards, and camping gear",
      },
      {
        name: "Locker Rooms & Saunas",
        floor: "1st Floor",
        type: "amenity",
        details: "Full day lockers, showers, and dry sauna",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Financial Markets Trading Room",
        floor: "1st Floor",
        type: "classroom",
        details:
          "Equipped with dual-screen Bloomberg Terminals and stock tickers",
      },
      {
        name: "Muma Undergraduate Advising Center",
        floor: "BSN 2102",
        type: "office",
        details:
          "Academic advisors for Finance, Marketing, Management, and Analytics",
      },
      {
        name: "Muma Corporate Mentorship Suite",
        floor: "1st Floor",
        type: "office",
        details:
          "Career fairs, internship coaching, and employer interview rooms",
      },
      {
        name: "Business Dean's Executive Suite",
        floor: "3rd Floor",
        type: "office",
        details: "Dean's office and college leadership",
      },
      {
        name: "BSN Auditoriums (BSN 1200 & 1300)",
        floor: "1st Floor",
        type: "classroom",
        details: "Large lecture auditoriums for core business courses",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "University Financial Aid & Scholarships",
        floor: "1st Floor (SVC 1027)",
        type: "service",
        details:
          "FAFSA questions, Bright Futures, loans, and aid disbursements",
      },
      {
        name: "Office of the Registrar",
        floor: "1st Floor (SVC 1034)",
        type: "service",
        details:
          "Class registration, graduation certification, and official transcripts",
      },
      {
        name: "University Cashier's Office",
        floor: "1st Floor (SVC 1038)",
        type: "service",
        details: "Tuition payments, Florida Prepaid billing, and fees",
      },
      {
        name: "Undergraduate Admissions",
        floor: "1st Floor (SVC 1036)",
        type: "service",
        details: "Admissions counseling and document drop-off",
      },
      {
        name: "Center for Career & Professional Development",
        floor: "2nd Floor (SVC 2088)",
        type: "service",
        details: "Resume reviews, Handshake job portal, and career fairs",
      },
      {
        name: "Student Accessibility Services (SAS)",
        floor: "1st Floor (SVC 1133)",
        type: "service",
        details:
          "Classroom and exam accommodations for students with disabilities",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        ...
        floor: "3rd Floor (CPR 358)",
        type: "office",
        details: "Faculty offices and undergraduate advising",
      },
      {
        name: "World Languages & Cultures",
        floor: "4th Floor (CPR 419)",
        type: "office",
        details: "Spanish, French, German, Japanese, and linguistics",
      },
      {
        name: "CPR 103 & 104 Main Auditoriums",
        floor: "1st Floor",
        type: "classroom",
        details: "High-capacity lecture halls for general education courses",
      },
      {
        name: "Humanities Computer Laboratory",
        floor: "2nd Floor",
        type: "study",
        details:
          "Equipped with software for translation and digital humanities",
      },
    ],
  },
  {
    ...
    hours:
      "Mon-Fri 7:30 AM - 9:00 PM (24/7 keycard access for engineering majors)",
    aliases: [
      "eng",
      "enb",
      "kopp",
    ...
    roomsAndServices: [
      {
        name: "College of Engineering Student Success Center",
        floor: "1st Floor",
        type: "office",
        details: "Dedicated engineering academic advisors and tutoring",
      },
      {
        name: "Engineering Design & Prototyping Machine Shop",
        floor: "Ground Floor",
        type: "amenity",
        details: "Laser cutters, CNC routers, lathes, and fabrication tools",
      },
      {
        name: "Civil & Environmental Engineering Dept.",
        floor: "ENG 118",
        type: "office",
        details: "Department chair, advising, and graduate research",
      },
      {
        name: "Industrial & Management Systems Engineering",
        floor: "ENG 215",
        type: "office",
        details: "Operations research, ergonomics labs, and faculty offices",
      },
      {
        name: "Kopp Open Computing Lab",
        floor: "ENG 202",
        type: "study",
        details: "High-power CAD/SolidWorks/MATLAB workstations",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        ...
        floor: "3rd Floor (ENB 342)",
        type: "office",
        details: "CSE faculty, advisors, and student labs",
      },
      {
        name: "Electrical Engineering Department",
        floor: "ENB 240",
        type: "office",
        details: "Power systems, circuits, and nanotechnology",
      },
      {
        name: "Cyber Florida (Florida Center for Cybersecurity)",
        floor: "1st Floor",
        type: "office",
        details: "Statewide cybersecurity operations and defense labs",
      },
      {
        name: "Autonomous Systems & Robotics Lab",
        floor: "1st Floor",
        type: "classroom",
        details: "Drone navigation and autonomous vehicle research",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "ISA 1051 & 1061 Giant Auditorium Theaters",
        floor: "1st Floor",
        type: "classroom",
        details:
          "300-seat tech-enabled lecture halls for General Chemistry & Biology",
      },
      {
        name: "Department of Physics",
        floor: "ISA 5102 (5th Floor)",
        type: "office",
        details: "Physics faculty, condensed matter research, and optics",
      },
      {
        name: "Department of Chemistry Research Floors",
        floor: "Floors 6 & 7",
        type: "office",
        details: "Organic chemistry and biochemistry synthesis research labs",
      },
      {
        name: "Interdisciplinary Student Study Lounges",
        floor: "Floors 2-5 (Atrium Overlook)",
        type: "study",
        details: "Glass-walled study lofts with whiteboards and campus views",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Undergraduate Chemistry Lab Stockroom",
        floor: "1st Floor",
        type: "service",
        details: "Pick up lab coats, splash goggles, and glassware kits",
      },
      {
        name: "General Chemistry Teaching Labs",
        floor: "2nd Floor",
        type: "classroom",
        details: "Fume-hood equipped stations for Chem 2045L & 2046L",
      },
      {
        name: "Organic Chemistry Teaching Labs",
        floor: "3rd Floor",
        type: "classroom",
        details: "Distillation and synthesis stations for Org Chem labs",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Outpatient Medical Clinic & Urgent Care",
        floor: "1st Floor",
        type: "service",
        details:
          "Treatment for illness, flu, minor injuries, and preventative care",
      },
      {
        ...
        type: "service",
        details:
          "Discounted student prescriptions and over-the-counter medicine",
      },
      {
        name: "Counseling Center & Psychological Services",
        floor: "2nd Floor",
        type: "service",
        details:
          "Free confidential individual therapy, crisis support, and workshops",
      },
      {
        ...
        type: "office",
        details:
          "Submit MMR and immunization records to clear registration holds",
      },
      {
        name: "Center for Student Well-Being",
        floor: "2nd Floor",
        type: "amenity",
        details:
          "Stress relief lounge, relaxation pods, and nutrition counseling",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Course Materials & Textbook Desk",
        floor: "2nd Floor",
        type: "service",
        details: "Rent, buy new/used, or pick up online book orders",
      },
      {
        name: "Official USF Apparel & Spirit Shop",
        floor: "1st Floor",
        type: "amenity",
        details: "Jerseys, hats, tailgate supplies, and USF alumni gear",
      },
      {
        name: "Apple & Dell Tech Store",
        floor: "1st Floor",
        type: "service",
        details: "Educational discounts on MacBooks, iPads, and accessories",
      },
      {
        name: "Bookstore Starbucks Express",
        floor: "1st Floor",
        type: "dining",
        details: "Coffee, iced tea, and pastries",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Main Arena Bowl & Court",
        floor: "Main Concourse",
        type: "amenity",
        details:
          "10,500 capacity arena for Bulls basketball and major concert tours",
      },
      {
        name: "USF Athletics Ticket Box Office",
        floor: "Gate A",
        type: "service",
        details: "Student student-section claim and general event tickets",
      },
      {
        name: "Arena Concessions & Team Store",
        floor: "Concourses Gates A-D",
        type: "dining",
        details: "Game day food, snacks, and official Bull gear",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Global Fare & Mongolian Grill Station",
        floor: "1st Floor",
        type: "dining",
        details: "Custom stir-fry made to order with fresh veggies and noodles",
      },
      {
        name: "True Balance Allergen-Friendly Station",
        floor: "1st Floor",
        type: "dining",
        details: "Free from the top 9 common food allergens",
      },
      {
        name: "Brick Oven Pizza & Italian Pasta",
        floor: "1st Floor",
        type: "dining",
        details: "Fresh baked artisan pizzas, strombolis, and pasta",
      },
      {
        name: "Fresh Salad & Deli Bar",
        floor: "1st Floor",
        type: "dining",
        details: "Build your own wraps, sandwiches, and crisp greens",
      },
      {
        name: "Dessert & Soft-Serve Ice Cream Bar",
        floor: "1st Floor",
        type: "dining",
        details: "Fresh baked cookies, pastries, and frozen yogurt",
      },
    ],
  },
  {
    ...
    sourceUrl:
      "https://www.usf.edu/student-affairs/campus-rec/facilities/the-fit.aspx",
    hours:
      "Mon-Thu 7:00 AM - 10:00 PM, Fri 7:00 AM - 8:00 PM, Weekends 10:00 AM - 6:00 PM",
    aliases: [
      "the fit",
      "fit",
      "village gym",
    ...
    roomsAndServices: [
      {
        name: "Cardio & Free Weight Floor",
        floor: "1st & 2nd Floors",
        type: "amenity",
        details: "Dumbbells, barbells, cable machines, and rowers",
      },
      {
        name: "Resort-Style Outdoor Swimming Pool",
        floor: "Outdoor Patio",
        type: "amenity",
        details: "Loungers, sun deck, and leisure swimming",
      },
      {
        name: "Spin & Cycling Studio",
        floor: "2nd Floor",
        type: "classroom",
        details: "Virtual cycling classes and open workout studio",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Publix Deli & Sub Counter",
        floor: "Front of Store",
        type: "dining",
        details:
          "Custom made hot & cold subs, chicken tenders, and grab-and-go meals",
      },
      {
        name: "Full-Service Grocery & Produce Aisles",
        floor: "Main Floor",
        type: "amenity",
        details:
          "Fresh fruit, dorm snacks, dairy, frozen foods, and toiletries",
      },
      {
        name: "Publix Pharmacy",
        floor: "Front Corner",
        type: "service",
        details: "Prescription refills, vaccines, and wellness items",
      },
      {
        name: "Presto! ATM",
        floor: "Vestibule",
        type: "service",
        details: "Surcharge-free ATM for most regional bank cards",
      },
    ],
  },
  {
    ...
    sourceUrl:
      "https://www.usf.edu/housing/residential-experience/hall-information/juniper-poplar.aspx",
    ...
    roomsAndServices: [
      {
        name: "Juniper Dining Hall",
        floor: "1st Floor Lobby",
        type: "dining",
        details:
          "Full residential dining hall with salad bar, grill, and home cooked meals",
      },
      {
        name: "JPH Starbucks Express",
        floor: "1st Floor",
        type: "dining",
        details:
          "Coffee, iced teas, and pastries right in the residence hall lobby",
      },
      {
        name: "JPH 24/7 Reception & Mail Desk",
        floor: "1st Floor",
        type: "service",
        details: "Package pickup and resident assistant lock-out support",
      },
      {
        name: "Floor Lounges & Laundry Rooms",
        floor: "Floors 2-9",
        type: "amenity",
        details: "Study lounges with Smart TVs and free app-monitored laundry",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Flip Kitchen / Argos Eats",
        floor: "1st Floor",
        type: "dining",
        details: "Rotational artisan flatbreads, burgers, and bowls",
      },
      {
        name: "Central Housing Package & Mail Center",
        floor: "1st Floor",
        type: "service",
        details: "Package locker pickup for Castor, Beta, and Kosove residents",
      },
      {
        name: "Argos Student Study Lounge",
        floor: "2nd Floor",
        type: "study",
        details: "Quiet tables and collaborative couches",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Castor Living-Learning Communities (LLC)",
        floor: "Multiple Floors",
        type: "study",
        details: "First-generation and honors cohort floors",
      },
      {
        name: "Castor Hall Recreation Lounge",
        floor: "1st Floor",
        type: "amenity",
        details: "Billiards, ping pong, community kitchen, and TV lounge",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Pinnacle Community Lounge",
        floor: "1st Floor",
        type: "amenity",
        details:
          "Gaming area, collaborative study booths, and community kitchen",
      },
      {
        name: "Floor Study Lounges",
        floor: "Floors 2-6",
        type: "study",
        details: "Quiet study spaces with whiteboard walls",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        ...
        floor: "Courtyard",
        type: "amenity",
        details: "Outdoor lounge chairs, grilling stations, and cabanas",
      },
      {
        name: "24-Hour Fitness Center & Yoga Studio",
        floor: "Clubhouse",
        type: "amenity",
        details: "Cardio equipment, free weights, and cross-training zone",
      },
      {
        name: "Academic Computer Lounge & Study Suites",
        floor: "Clubhouse",
        type: "study",
        details: "High-speed Wi-Fi, private study pods, and free printing",
      },
      {
        name: "Bull Runner Shuttle Pickup",
        floor: "Fletcher Ave & 42nd St",
        type: "service",
        details: "Direct university shuttle stop connecting to campus core",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Botanical Gardens Welcome Center & Gift Shop",
        floor: "Entrance",
        type: "service",
        details:
          "Garden maps, local honey produced on-site, and succulent plants",
      },
      {
        name: "Orchid Greenhouse & Bromeliad Collection",
        floor: "Central Gardens",
        type: "amenity",
        details: "World-class collection of exotic and native Florida orchids",
      },
      {
        name: "Lake & Wetland Boardwalk Trail",
        floor: "Nature Preserve",
        type: "amenity",
        details: "Observation deck for turtles, herons, and water lilies",
      },
    ],
  },
  {
    id: "cam",
    osmName:
      "University Of South Florida Contemporary Art Museum;Contemporary Art Museum",
    code: "CAM",
    ...
    hours:
      "Mon-Fri 10:00 AM - 5:00 PM, Thu until 8:00 PM, Sat 1:00 PM - 4:00 PM",
    aliases: [
      "cam",
      "museum",
      "contemporary art",
    ...
    roomsAndServices: [
      {
        name: "Main Exhibition Galleries (Galleries 1-3)",
        floor: "1st Floor",
        type: "amenity",
        details:
          "Rotating international and national contemporary art exhibitions",
      },
      {
        name: "Graphicstudio Print Archive & Display",
        floor: "1st Floor",
        type: "office",
        details:
          "Limited-edition prints and sculptures by world-renowned artists",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Office of Veteran Success (OVS)",
        floor: "1st Floor",
        type: "service",
        details:
          "GI Bill benefits, VA certifying officials, and transition advising",
      },
      {
        name: "Veterans Computer & Study Lounge",
        floor: "1st Floor",
        type: "study",
        details:
          "Free printing, study stations, and coffee for military-connected students",
      },
      {
        name: "USF Joint ROTC Command Offices",
        floor: "2nd Floor",
        type: "office",
        details:
          "Army, Naval, and Air Force ROTC cadet advising and uniform issue",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Shimberg Health Sciences Library",
        floor: "Health Quad",
        type: "study",
        details:
          "Medical journals, quiet study suites, and health informatics labs",
      },
      {
        name: "USF Health Learning & Lecture Auditoriums",
        floor: "1st Floor",
        type: "classroom",
        details: "Tiered multi-media classrooms for medical and PA cohorts",
      },
      {
        name: "Clinical Simulation & Skills Training Center",
        floor: "2nd Floor",
        type: "classroom",
        details: "High-fidelity clinical mannequin patient simulation rooms",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "24/7 Police Dispatch & Lobby",
        floor: "1st Floor",
        type: "service",
        details: "Emergency walk-ins, crime reports, and safety inquiries",
      },
      {
        name: "USF SafeWalk Escort Service",
        floor: "Dispatch",
        type: "service",
        details:
          "Call anytime at night for a uniformed safety escort anywhere on campus",
      },
      {
        name: "Campus Lost & Found Central",
        floor: "1st Floor",
        type: "service",
        details: "Register lost keys, wallets, laptops, and IDs",
      },
    ],
  },
  {
    ...
    sourceUrl:
      "https://www.americancampus.com/student-apartments/fl/tampa/avalon-heights",
    ...
    roomsAndServices: [
      {
        name: "Clubhouse & Student Study Center",
        floor: "1st Floor",
        type: "study",
        details:
          "Computer workstations, printing, and private conference rooms",
      },
      {
        name: "Resort-Style Swimming Pool & Spa",
        floor: "Courtyard",
        type: "amenity",
        details:
          "Sun lounge deck, outdoor BBQ grills, and sand volleyball court",
      },
      {
        name: "24/7 Fitness Center",
        floor: "Clubhouse",
        type: "amenity",
        details: "Cardio theater, free weights, and strength machines",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Dual Resort Pools & Cabana Lounge",
        floor: "Courtyard",
        type: "amenity",
        details: "Twin swimming pools with sundeck and cabanas",
      },
      {
        name: "Executive Business & Study Center",
        floor: "Clubhouse",
        type: "study",
        details:
          "iMac stations, high-speed study pods, and complimentary printing",
      },
      {
        name: "24-Hour Multi-Level Fitness Center",
        floor: "Clubhouse",
        type: "amenity",
        details: "Weight lifting area and cardio training equipment",
      },
    ],
  },
  {
    ...
    sourceUrl:
      "https://www.americancampus.com/student-apartments/fl/tampa/the-province",
    hours: "Mon-Fri 9:00 AM - 6:00 PM, Sat 10:00 AM - 5:00 PM",
    aliases: [
      "province",
      "the province",
    ...
    roomsAndServices: [
      {
        name: "Province Resident Clubhouse",
        floor: "Clubhouse",
        type: "service",
        details: "Leasing staff, resident parcel lockers, and concierge",
      },
      {
        name: "Private Academic Study Pods",
        floor: "Clubhouse",
        type: "study",
        details: "Quiet collaborative study rooms with smart screens",
      },
      {
        name: "Zero-Entry Resort Pool & Movie Theater",
        floor: "Clubhouse Area",
        type: "amenity",
        details:
          "Poolside cabanas, resident clubhouse cinema, and gaming lounge",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Cambridge Woods Clubhouse & Pool",
        floor: "Main Grounds",
        type: "amenity",
        details: "Lakeside swimming pool and resident clubhouse",
      },
      {
        name: "Dog Park & Nature Trails",
        floor: "Grounds",
        type: "amenity",
        details: "Pet-friendly recreation areas and wooded paths",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "The Retreat Clubhouse & Golf Simulator",
        floor: "Clubhouse",
        type: "amenity",
        details: "Virtual golf simulator, billiards, and game room",
      },
      {
        name: "Expansive Multi-Tier Pool",
        floor: "Courtyard",
        type: "amenity",
        details: "Resort swimming pool with outdoor jumbotron screen",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Gaming Lounge & Cybersports Den",
        floor: "Clubhouse",
        type: "amenity",
        details: "High-spec gaming systems and arcade titles",
      },
      {
        name: "State-of-the-Art Fitness Center",
        floor: "Clubhouse",
        type: "amenity",
        details: "CrossFit rig, cardio equipment, and free weights",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        ...
        floor: "Top Floor",
        type: "amenity",
        details: "Panoramic views of USF campus and lounge seating",
      },
      {
        name: "Study Lab & Media Suites",
        floor: "1st Floor",
        type: "study",
        details: "Collaborative and private work rooms",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        ...
        floor: "1st Floor",
        type: "dining",
        details: "Freshly made hot subs, wraps, and fried chicken tenders",
      },
      {
        name: "Publix Pharmacy",
        floor: "1st Floor",
        type: "service",
        details:
          "Prescription refills, immunizations, and healthcare essentials",
      },
      {
        name: "Presto! ATM",
        floor: "Lobby",
        type: "service",
        details: "Fee-free ATM services for partner financial networks",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Moffitt Outpatient Center & Clinics",
        floor: "Main Hospital",
        type: "service",
        details: "Specialized oncology patient clinics and consultation suites",
      },
      {
        name: "Stabile & Moffitt Research Laboratories",
        floor: "Research Wing",
        type: "classroom",
        details: "Biomedical and translational cancer discovery labs",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Main Hospital Emergency & Urgent Care",
        floor: "1st Floor West",
        type: "service",
        details: "24/7 emergency medical care for eligible veterans",
      },
      {
        name: "USF Health Clinical Teaching Suites",
        floor: "Multiple Floors",
        type: "classroom",
        details: "Residency education and clinical instruction rounds",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Pediatric Orthopedic Specialty Center",
        floor: "1st Floor",
        type: "service",
        details:
          "Specialized clinical consultation for pediatric mobility and scoliosis",
      },
      {
        name: "Pediatric Motion Analysis Center",
        floor: "1st Floor",
        type: "classroom",
        details:
          "Advanced bio-mechanics laboratory analyzing gait and movement",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Innovation Hub & Collaborative Workspaces",
        floor: "Level 1",
        type: "study",
        details:
          "Tech incubation offices and collaborative student meeting spaces",
      },
      {
        name: "Retail & Dining Pavilion",
        floor: "Main Concourse",
        type: "dining",
        details: "Apparel shops, dining options, and entertainment venues",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "Transit Ticket & Customer Information Desk",
        floor: "Central Terminal",
        type: "service",
        details: "Route maps, Flamingo Fares cards, and transfer info",
      },
      {
        name: "Multi-Bay Bus Transit Platform",
        floor: "Ground Level",
        type: "service",
        details: "Covered boarding bays for Bull Runner and HART lines",
      },
    ],
  },
  {
    ...
    roomsAndServices: [
      {
        name: "USF Health Pharmacy & Lobby",
        floor: "1st Floor",
        type: "service",
        details: "Prescription medications and clinical check-in",
      },
      {
        name: "Multi-Specialty Clinical Suites",
        floor: "Floors 2-5",
        type: "service",
        details: "Cardiology, dermatology, orthopedics, and neurology",
      },
      {
        name: "Ambulatory Surgery Center",
        floor: "6th Floor",
        type: "service",
        details: "State-of-the-art outpatient surgical suites",
      },
    ],
  },
];
...
// Codes checked against USF's campus map directory on 2026-09-12.
// This verifies building identity only, not room locations or opening hours.
export const CAMPUS_DIRECTORY_SOURCE =
  "https://www.usf.edu/parking/documents/campus-map-directory.pdf";
const identities: [string, string, BuildingCategory][] = [
  ["University Library", "LIB", "Academics"],
  ["Phyllis P Marshall Center", "MSC", "Student Life & Dining"],
  ["Judy Genshaft Honors College", "HON", "Academics"],
  ["USF Muma College of Business", "BSN", "Academics"],
  ["Cooper Hall Arts and Sciences Building", "CPR", "Academics"],
  ["Communication and Information Sciences", "CIS", "Academics"],
  ["Natural and Environmental Sciences", "NES", "Academics"],
  ["College of Education", "EDU", "Academics"],
  ["Social Sciences Building", "SOC", "Academics"],
  ["University Lecture Hall", "ULH", "Academics"],
  ["Behavioral Sciences Building", "BEH", "Academics"],
  ["Chemistry", "CHE", "Academics"],
  ["Interdisciplinary Sciences", "ISA", "Academics"],
  ["Pinnacle Hall", "RPN", "Housing & Dorms"],
  [
    "Carol & Frank Morsani Center for Advanced Health Care",
    "MDH",
    "Health & Medicine",
  ],
  ["Science Center", "SCA", "Academics"],
  ["Bioscience Building", "BSF", "Academics"],
  ["Life Science Annex", "LSA", "Academics"],
  ["Edgar W Kopp Engineering Building", "ENG", "Academics"],
  ["Engineering Building II", "ENB", "Academics"],
  ["Engineering Building III", "ENC", "Academics"],
  ["Center for Urban Transportation Research", "CUT", "Academics"],
  ["College of Arts & Sciences Multidisciplinary Complex", "CMC", "Academics"],
  ["College of Public Health", "CPH", "Health & Medicine"],
  ["Physical Education Building", "PED", "Athletics & Rec"],
  ["Campus Recreation Center", "REC", "Athletics & Rec"],
  ["Student Services Building", "SVC", "Services & Admin"],
  ["USF Bookstore", "BKS", "Student Life & Dining"],
  ["CW Bill Young Hall", "CWY", "Services & Admin"],
  ["Castor Hall", "RBC", "Housing & Dorms"],
  ["Beta Hall", "RBE", "Housing & Dorms"],
  ["Kosove Hall", "RKO", "Housing & Dorms"],
];
const retainedCodes = new Set(["FIT", "HUB", "JPH", "MDC", "CAM"]);
for (const b of USF_BUILDINGS_CATALOG) {
  b.aliases = [...(b.aliases || []), b.code];
  b.codeVerified = retainedCodes.has(b.code);
  if (!b.codeVerified) b.code = "";
}
for (const [osmName, code, category] of identities) {
  const existing = USF_BUILDINGS_CATALOG.find((b) => b.osmName === osmName);
  if (existing) {
    existing.code = code;
    existing.category = category;
    existing.codeVerified = true;
  } else {
    USF_BUILDINGS_CATALOG.push({
      id: `campus-${code.toLowerCase()}`,
      osmName,
      code,
      name: osmName,
      shortName: osmName,
      ...
      freshmanTip: "",
      roomsAndServices: [],
      sourceUrl: CAMPUS_DIRECTORY_SOURCE,
    });
  }
}
...
// Never invent official codes, opening hours, indoor facilities, or access advice.
export function getBuildingProfile(osmName: string): USFBuilding {
  ...
  const valid =
    trimmed && !/^(Building\s*\d+|Bldg\s*#?\d+|\d+)$/i.test(trimmed);
  return {
    id: valid ? trimmed.toLowerCase().replace(/[^a-z0-9]+/g, "-") : "unnamed",
    osmName: valid ? trimmed : "",
    name: valid ? trimmed : "",
    shortName: valid ? trimmed : "",
    code: "",
    codeVerified: false,
